...
const Enroll: React.FC = () => {
 ...
 className="w-24 h-24 bg-emerald-100 /30 rounded-full flex items-center justify-center mx-auto"
 >
 <CheckCircle2 className="w-12 h-12 text-emerald-600 " />
 </motion.div>
 <div className="space-y-4">
 <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Step 1 Complete!</h2>
 <p className="text-slate-600 text-xl font-medium leading-relaxed max-w-md mx-auto">
 ...
 >
 <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-6 leading-[0.95] tracking-tighter">
 ...
 className="bg-white/90 /80 backdrop-blur-2xl p-10 md:p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-200/50 /50"
 >
