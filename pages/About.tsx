...
const About: React.FC = () => {
  return (
    <div className="min-h-screen pt-24 sm:pt-28 pb-24 sm:pb-32 bg-bg transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="text-center max-w-4xl mx-auto mb-28">
          ...
          <h1 className="text-[2rem] sm:text-4xl md:text-6xl font-black text-heading mb-8 tracking-tighter leading-[0.9]">
          ...
          <p className="text-base sm:text-lg text-text-secondary font-medium leading-relaxed max-w-3xl mx-auto mb-12">
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <MotionDiv
                ...
                className="bg-surface border border-border rounded-2xl sm:rounded-2xl p-6 text-left hover:border-emerald-500 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                <div className="w-11 h-11 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 mb-4">{item.icon}</div>
                <h3 className="font-black text-heading text-sm mb-1.5">{item.title}</h3>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-28 max-w-4xl mx-auto">
          ...
          <h2 className="text-[2rem] sm:text-4xl md:text-5xl font-black text-heading mb-8 tracking-tighter">Why We Built Edu Alt Tech</h2>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-28">
          <div className="text-center mb-16">
            ...
            <h2 className="text-[2rem] sm:text-4xl md:text-5xl font-black text-heading tracking-tighter">Explore by Subject</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <MotionDiv
                ...
                className="bg-surface border border-border rounded-2xl sm:rounded-2xl p-6 sm:p-8 hover:border-emerald-500 hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
              >
                ...
                <h3 className="text-lg sm:text-xl font-black text-heading mb-4">{cat.title}</h3>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-28 max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-[2rem] sm:text-4xl md:text-5xl font-black text-heading tracking-tighter">One Platform. Multiple Opportunities.</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <MotionDiv
                ...
                className="flex items-center gap-3 p-5 bg-surface border border-border rounded-xl sm:rounded-2xl hover:border-emerald-500 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                <CheckCircle className="w-6 h-6 text-emerald-500 shrink-0" />
                <span className="font-bold text-heading text-sm sm:text-base">{item}</span>
              </MotionDiv>
            ))}
          </div>
        </MotionDiv>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-28">
          <div className="text-center mb-16">
            ...
            <h2 className="text-[2rem] sm:text-4xl md:text-5xl font-black text-heading tracking-tighter">Your Path to Success</h2>
          </div>

          <div className="mb-16">
            <h3 className="text-xl sm:text-2xl font-black text-heading mb-10 text-center">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                >
                  ...
                  <h4 className="text-sm sm:text-lg font-black text-heading mb-2">{item.title}</h4>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-28 relative">
          ...
          <div className="text-center mb-16 relative z-10">
            ...
            <h2 className="text-[2rem] sm:text-4xl md:text-5xl font-black text-heading mb-4 tracking-tighter">
            ...
            <p className="text-sm sm:text-lg text-text-secondary">The innovators shaping the future of Edu Alt Tech</p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-4 top-0 bottom-6 w-16 bg-gradient-to-r from-bg to-transparent pointer-events-none z-20 hidden lg:block" />
            <div className="absolute -right-4 top-0 bottom-6 w-16 bg-gradient-to-l from-bg to-transparent pointer-events-none z-20 hidden lg:block" />
          </div>
        </MotionDiv>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-28 relative">
          ...
          <div className="text-center mb-16 relative z-10">
            ...
            <p className="text-sm sm:text-lg text-text-secondary">The dedicated folks who keep things running smoothly</p>
          </div>
        ...
        <MotionDiv initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="bg-gradient-to-br from-primary via-emerald-950 to-primary rounded-2xl sm:rounded-2xl p-10 sm:p-14 lg:p-24 text-center shadow-2xl overflow-hidden relative"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-base sm:text-xl text-text-muted mb-12 max-w-2xl mx-auto font-medium">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/contact" className="px-8 sm:px-10 py-4 sm:py-5 bg-surface/10 hover:bg-surface/20 text-white border border-white/20 rounded-2xl font-bold transition-all backdrop-blur-sm hover:-translate-y-1 text-sm sm:text-base">
                Partner With Us
              </Link>
            </div>
          </div>
...
function TeamCard({ member, idx }: { member: typeof TEAM[0]; idx: number }) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-surface border border-border rounded-2xl sm:rounded-2xl p-6 sm:p-8 transition-colors duration-500 text-center overflow-hidden w-full sm:w-[340px] lg:w-[380px]"
    >
      <div className="absolute inset-0 bg-gradient-to-b from-bg/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      <div className="relative z-10">
        <div className={`w-36 h-36 sm:w-48 sm:h-48 lg:w-56 lg:h-56 mx-auto mb-6 rounded-2xl sm:rounded-2xl overflow-hidden bg-gradient-to-br ${gradients[idx % gradients.length]} p-[5px] shadow-xl`}>
          <div className="w-full h-full rounded-[1.3rem] sm:rounded-[1.6rem] overflow-hidden bg-surface relative">
            {member.image && !imgError ? (
              ...
              <div className="w-full h-full flex items-center justify-center font-black text-2xl sm:text-4xl lg:text-5xl text-text-muted bg-bg">
        ...
        <h3 className="text-base sm:text-lg font-black text-heading mb-1 tracking-tight leading-tight">{member.name}</h3>
        ...
        <div className="flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
          {member.email && (
            <a href={`mailto:${member.email}`} className="p-2 rounded-xl bg-surface-2 text-text-secondary hover:text-emerald-500 hover:bg-emerald-50 transition-colors">
              <Mail className="w-4 h-4" />
            </a>
          )}
          {member.linkedin && (
            <a href={member.linkedin} target="_blank" rel="noreferrer" className="p-2 rounded-xl bg-surface-2 text-text-secondary hover:text-blue-600 hover:bg-blue-50 transition-colors">
