...
const Signup: React.FC = () => {
 ...
 className="w-full px-5 py-4 bg-slate-50 rounded-2xl border border-slate-200 focus:border-[#90EE90] focus:ring-4 focus:ring-emerald-100 :ring-emerald-900/40 outline-none transition-colors transition-shadow pr-12"
 />
 <button
 type="button"
