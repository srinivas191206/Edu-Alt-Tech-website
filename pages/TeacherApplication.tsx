...
const TeacherApplication: React.FC = () => {
 ...
 <button type="button" onClick={() => toggleSection(section)} className="w-full flex items-center justify-between p-4 bg-slate-50 /50 rounded-xl border border-slate-200 hover:bg-slate-100 :bg-slate-800 transition-colors">
 ...
 return (
 <div className="min-h-screen pt-28 pb-32 px-6 bg-slate-50 [#020617] relative overflow-hidden">
 <div className="absolute top-0 left-1/2 w-[700px] h-[700px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-emerald-500/5 to-indigo-500/5 /10 /10 rounded-full blur-[60px] pointer-events-none" />
 ...
 <button onClick={() => navigate(-1)} className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-900 :text-white transition-colors mb-6 font-medium">
 ...
 <div className="bg-white/90 /80 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] shadow-2xl border border-slate-200/50 /50">
 ...
 You are applying for: <strong className="text-slate-900 ">{course.title}</strong>
 </p>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-slate-50/50 /20 rounded-2xl border border-slate-200 /50">
 ...
 <div className="space-y-4 p-4 bg-slate-50/50 /20 rounded-2xl border border-slate-200 /50">
 ...
 <span className="text-sm font-medium text-slate-700 ">I agree that content I create remains my ownership but can be used by the platform for promotional purposes.</span>
 </label>
 <label className="flex items-start gap-3 cursor-pointer">
 ...
 <span className="text-sm font-medium text-slate-700 ">I agree to the revenue sharing model as defined by the platform.</span>
 </label>
 </div>
 )}
