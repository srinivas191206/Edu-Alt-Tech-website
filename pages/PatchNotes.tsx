          ...
          <div className="space-y-8">
            {notes.map((note, idx) => (
              <motion.div
                ...
                className="bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl p-10 rounded-[2.5rem] border border-slate-200/50 dark:border-slate-800/50 shadow-xl relative overflow-hidden group hover:-translate-y-1 hover:shadow-2xl transition-transform transition-shadow duration-300"
              >
