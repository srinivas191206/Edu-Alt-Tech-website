...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-slate-50 text-slate-900 overflow-hidden min-h-screen relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-8">
            ...
            <MotionDiv 
              ...
              className="flex flex-wrap gap-8 pt-8 border-t border-slate-200 max-w-xl"
            >
              {[
            ...
            >
              ...
              <div className="hidden md:block absolute inset-0 w-full h-full pointer-events-none">
                <div className="absolute inset-0 animate-orbit-1 flex items-center justify-center">
                  <span className="bg-white px-4 py-2 rounded-full border border-slate-100 shadow-md font-bold text-emerald-600 :text-emerald-400 text-base flex items-center gap-1.5 select-none pointer-events-auto">
                ...
                return (
                  <Link key={idx} to={`/courses/${courseId}`} className="block">
                    <MotionDiv
                      ...
                      className="group bg-white border border-slate-200 rounded-[2.5rem] p-7 transition-all duration-300 hover:border-slate-300 relative flex flex-col justify-between h-[280px]"
                    >
                      <div>
      ...
      {/* ═══════════════════════════════════════════════════════ Learning Categories */}
      <section className="py-32 px-6 bg-slate-100/ border-y border-slate-200 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <MotionDiv
                ...
                className="bg-white border border-slate-200 rounded-[2.5rem] p-8 hover:shadow-xl transition-all duration-300 hover:border-slate-300 flex flex-col justify-between"
              >
                <div>
              ...
              <div className="glow-card rounded-[2.5rem] border border-slate-200 overflow-hidden shadow-2xl bg-white p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 relative">
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4">
                  {[
                    ...
                    <div key={idx} className="bg-slate-50 p-2.5 sm:p-4 rounded-2xl border border-slate-200 flex flex-col justify-between">
      ...
      {/* ═══════════════════════════════════════════════════════ Why Edu Alt Tech */}
      <section className="py-32 px-6 relative bg-white border-y border-slate-200
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <MotionDiv
                ...
                className="flex items-center gap-4 p-6 bg-white border border-slate-200 rounded-2xl hover:border-emerald-500 hover:shadow-lg transition-all duration-300 group"
              >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <MotionDiv
                ...
                className="bg-white border border-slate-200 rounded-[2rem] p-8 hover:-translate-y-1.5 transition-all duration-300 shadow-sm hover:shadow-xl text-left flex flex-col justify-between h-[230px] hover:border-slate-300"
              >
