...
const BehaviorInsights: React.FC = () => {
 ...
 className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-xl">
 ...
 sortBy === s.key ? 'bg-amber-500 text-white shadow-lg' : 'bg-white text-slate-500 border border-slate-200 '
 }`}
