        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          {SERVICES.map((service, idx) => (
            <motion.div
              ...
              className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] p-10 hover:border-emerald-500 hover:shadow-2xl hover:-translate-y-2 transition-colors transition-shadow transition-transform duration-500"
            >
              <div className="flex items-start gap-6 mb-8">
                <div className="text-emerald-500 bg-emerald-50 dark:bg-emerald-900/20 w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
                  {iconMap[service.icon]}
                </div>
                <div>
                  <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-2">{service.title}</h2>
