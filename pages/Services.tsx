...
const Services: React.FC = () => {
 ...
 transition={{ delay: idx * 0.1, duration: 0.6 }}
  className="group bg-surface border border-border rounded-2xl p-10 hover:border-emerald-500 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
 >
 <div className="flex items-start gap-6 mb-8">
  <div className="text-emerald-500 bg-emerald-50 w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
 {iconMap[service.icon]}
 </div>
 <div>
 <h2 className="text-2xl font-black text-heading mb-2">{service.title}</h2>
 ...
 viewport={{ once: true }}
  className="bg-gradient-to-br from-primary via-emerald-950 to-primary rounded-2xl p-14 lg:p-20 text-center shadow-2xl overflow-hidden relative"
 >
