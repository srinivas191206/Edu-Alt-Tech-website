...
const FeaturesSection: React.FC = () => {
 ...
 className="flex p-2 bg-slate-100 rounded-[2rem] mb-20 shadow-inner border border-slate-200/50 /50 max-w-full overflow-x-auto no-scrollbar"
 >
 ...
 <p className="text-slate-600 leading-relaxed text-lg font-medium relative z-10">{feat.desc}</p>
 </motion.div>
 ))}
 </motion.div>
 </AnimatePresence>
