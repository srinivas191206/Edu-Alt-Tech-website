...
const HeroSection: React.FC = () => {
 return (
 <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden bg-slate-50 transition-colors duration-300 min-h-[95vh] flex flex-col justify-center">
 <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMSIgY3k9IjEiIHI9IjEiIGZpbGw9InJnYmEoMTQ4LCAxNjMsIDE4NCwgMC4xNSkiLz48L3N2Zz4=')] opacity-50 pointer-events-none" />
 ...
 <motion.div variants={item} className="lg:col-span-7 flex flex-col justify-center bg-white /60 backdrop-blur-2xl p-10 md:p-16 rounded-[2.5rem] md:rounded-[3rem] border border-slate-200/50 /50 shadow-2xl shadow-indigo-500/5 relative overflow-hidden">
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-emerald-400/10 to-indigo-500/10 /10 /10 rounded-full blur-[80px] -mt-40 -mr-40 pointer-events-none" />
 
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 /80 border border-slate-100 /50 text-slate-800 text-xs sm:text-sm font-bold mb-8 w-max relative z-10 shadow-sm">
 <Sparkles className="w-4 h-4 text-emerald-500" />
 <span>Premium Education Architecture</span>
 </div>
 
 <h1 className="text-5xl md:text-[5rem] lg:text-[5.5rem] font-black text-slate-900 mb-8 tracking-tighter leading-[0.95] relative z-10">
 Future-Proofed
 ...
 <p className="text-lg md:text-xl text-slate-600 mb-12 max-w-xl leading-relaxed relative z-10 font-medium">
