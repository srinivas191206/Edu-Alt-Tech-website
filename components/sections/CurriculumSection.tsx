...
const CurriculumSection: React.FC = () => {
 ...
 <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-blue-500/5 /10 rounded-full blur-[50px] -translate-y-1/2 pointer-events-none" />
 ...
 <div className="relative bg-white/90 /90 backdrop-blur-2xl rounded-[3rem] border border-white/50 /50 shadow-2xl p-10 z-10">
 <div className="flex items-center gap-4 mb-10">
 <div className="p-3 bg-blue-100 /40 text-blue-600 rounded-2xl shadow-sm">
 <Target className="w-7 h-7" />
 </div>
 <div>
 <h4 className="text-xl font-black text-slate-900 tracking-tight">Learning Outcomes</h4>
 ...
 <span>{bar.label}</span>
 <span className="text-blue-600 ">{bar.width}%</span>
 </div>
 ...
 >
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 /20 border border-blue-100 /30 text-blue-600 font-bold uppercase tracking-widest text-xs mb-8 shadow-sm">
 Adaptive Learning
 </div>

 <h2 className="text-5xl lg:text-[4.5rem] font-black text-slate-900 mb-8 leading-[0.95] tracking-tighter">
 ...
 >
 <div className={`bg-slate-50 p-4 rounded-2xl ${feat.color} shadow-sm border border-slate-100 group-hover:scale-110 ${feat.hoverBg} group-hover:text-white transition-transform duration-300 flex-shrink-0`}>
 {feat.icon}
 </div>
 <div>
 <h4 className="font-black text-slate-900 text-xl mb-2 tracking-tight">{feat.title}</h4>
