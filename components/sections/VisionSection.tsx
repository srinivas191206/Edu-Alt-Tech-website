...
const VisionSection: React.FC = () => {
 ...
 viewport={{ once: true }}
 className="inline-flex items-center justify-center p-4 bg-emerald-100 /30 text-emerald-600 rounded-full mb-8 shadow-inner"
 >
 ...
 className="text-xl text-slate-600 leading-relaxed mb-12"
 >
 ...
 >
 <div className="flex items-center gap-3 text-slate-700 font-semibold bg-white px-6 py-3 rounded-full shadow-sm border border-slate-100 ">
