...
const LearningPathView: React.FC<LearningPathViewProps> = ({ courseId, courseTitle, courseDescription }) => {
 ...
 <span className="px-3 py-1 bg-slate-100 rounded-full text-[10px] font-black uppercase text-slate-500">{path.currentDifficulty}</span>
 </div>
 ...
 className="group flex items-center gap-4 p-4 rounded-2xl hover:bg-slate-50 :bg-slate-800/50 transition-colors cursor-pointer"
