...
const FlashcardDeck: React.FC = () => {
 ...
 <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight">AI Flashcards</h1>
 <p className="text-slate-500 text-lg font-medium">Enter any topic to generate a deck of flashcards</p>
 </div>
 ...
 <h2 className="text-2xl font-black text-slate-900 mb-8 text-center tracking-tight">{deckTitle}</h2>
 ...
 {/* Front */}
 <div
 className="absolute inset-0 bg-white rounded-[2.5rem] border-2 border-slate-200 shadow-2xl flex flex-col items-center justify-center p-10"
 ...
 onClick={prevCard}
 disabled={current === 0}
 className="p-4 bg-white border border-slate-200 rounded-2xl shadow-lg hover:shadow-xl transition-shadow disabled:opacity-30"
 >
 ...
 className="px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl shadow-lg flex items-center gap-2 hover:scale-105 transition-transform"
 >
