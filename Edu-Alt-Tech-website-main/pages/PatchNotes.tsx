  ...
  return (
    <div className="min-h-screen pt-32 pb-32 px-6 bg-slate-50 text-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10" ref={containerRef}>
        ...
        >
           <div>
             <Link to="/" className="inline-flex items-center gap-2 text-slate-500 hover transition-colors mb-6 font-medium">
               <ArrowLeft className="w-4 h-4" /> Back to Home
             </Link>
             <h1 className="text-5xl md font-black flex items-center gap-4 tracking-tighter">
          ...
          <div className="space-y-8">
            {notes.map((note, idx) => (
              <motion.div
                ...
                className="bg-white/90 backdrop-blur-xl p-10 rounded-[2.5rem] border border-slate-200/50 shadow-xl relative overflow-hidden group hover:-translate-y-1 hover transition-all duration-300"
              >
                ...
                {isAdmin && (
                  <button 
                    ...
                    className="absolute top-12 right-6 p-2 bg-rose-100 text-rose-600 rounded-xl hover transition"
